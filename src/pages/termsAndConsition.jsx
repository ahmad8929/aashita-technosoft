...
const TermsAndConditions = ({ isOpen, onClose }) => {
    ...
    const handleAgree = () => {
        // You can perform additional logic here if needed before closing the modal
        onClose(); // Close the modal when "I Agree" is clicked
    };

    return (
        <Modal isOpen={isOpen} isCentered>
            <ModalOverlay />
            <ModalContent maxW="800px" maxH="700px" p={"10px"}>
